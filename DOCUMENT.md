...
| `matchSnapshot`                       | **path**: *string*. The `set` path for snapshot. **matchRegex.pattern**: *string*. The value regex pattern that should exist for snapshot. **notMatchRegex.pattern**: *string*. The value regex pattern that not should exist for snapshot.                                                                                      | Assert the value of **path** is the same as snapshotted last time. Check [doc](./README.md#snapshot-testing) below.                                                                                                              | <pre>matchSnapshot:<br/>  path: spec<br/> matchRegex:<br/>  pattern: my-notes$<br/> notMatchRegex:<br/>  pattern: this-notes$<br/></pre>                                                                                                                 |
